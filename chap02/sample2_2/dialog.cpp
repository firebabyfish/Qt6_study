...
{
    ui->setupUi(this);
    connect(ui->radioButton_black, SIGNAL(clicked()), this, SLOT(do_setFontColor()));
...
void Dialog::on_checkBox_itailc_clicked(bool checked)
{//复选框
    QFont font = ui->plainTextEdit->font();
...
void Dialog::on_pushButton_Clear_clicked(bool checked)
{//“清空”按钮
